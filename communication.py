...
class Communication:
    ...
    def send_email(self, email_address, person_name, task_name, uuid): # the method that sends emails as describied in What has been done so far with Communication Library
        to = email_address
