...
app = Flask(__name__)
"""This is the Human programs flask file that handles the web site. """


@app.route('/')  # This is the page that is run if the person goes to the main page. Onboarding Library,
def run():
    """Until unboarding code is ready communication method will be used through here."""
...
def change_task_status(unique_id, answer):
    """allows for the status of takss to be changed"""
...
def open_task_page(task_id):
    """Allows for task pages to be opend"""
